package ch.dboeckli.guru.jpa.sdjpa.inheritance.log;
...
class ConfigChangeListenerTest {
    ...
    private static final String LOGGER_NAME = "ch.dboeckli.guru.jpa.sdjpa.inheritance.log.ConfigChangeListener";
