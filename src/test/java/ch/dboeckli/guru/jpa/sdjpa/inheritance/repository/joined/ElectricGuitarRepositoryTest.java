...
class ElectricGuitarRepositoryTest {
  ...
  @Autowired ElectricGuitarRepository electricGuitarRepository;
  ...
  void testSaveElectricGuitar() {
    ...
    Optional<ElectricGuitar> foundElectricGuitar =
        electricGuitarRepository.findById(savedElectricGuitar.getId());
    assertAll(
        "Electric Guitar",
        () -> assertTrue(foundElectricGuitar.isPresent(), "Electric guitar should be found"),
        () ->
            foundElectricGuitar.ifPresent(
                guitar -> {
  ...
  void testEqualsWithSameId() {
    ElectricGuitar electricGuitar1 = electricGuitarRepository.save(new ElectricGuitar());
    ElectricGuitar electricGuitar2 =
        electricGuitarRepository.findById(electricGuitar1.getId()).orElseThrow();
